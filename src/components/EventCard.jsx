...
const EventCard = () => {
    return(
        <div className='border-2 border-[#DE3500] p-2 flex flex-col gap-2'>
            ...
            <div className='text-sm font-extrabold'>by Jon Doe</div>
            <div className='font-montserrat'><span className='pi pi-calendar'></span><span className='font-black'> Event Date:</span> 21-05-2023</div>
            <div className='font-montserrat'><span className='pi pi-map-marker'></span><span className='font-black'> Venue:</span> TKM College of Engineering</div>

...
const ResourceCard = () => {
  return (
    <div className="border-2 border-[#E5245A] h-auto w-auto rounded-md mt-12 mb-12 mr-12 ml-12 md:mr-32 md:ml-32">
      <div className="border-8 border-black mb-2 md:mb-2 md:mt-2 flex flex-col md:flex-row">
        ...
        <div className="relative bg-[#E5245A]  text-white md:w-1/8 md:px-8 md:py-6 md:mr-2 md:ml-4 rounded-md group">
